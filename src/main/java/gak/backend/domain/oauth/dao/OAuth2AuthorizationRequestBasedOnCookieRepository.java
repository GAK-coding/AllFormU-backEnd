//package gak.backend.domain.oauth.dao;
//
...
//        }
//
//        CookieUtil.addCookie(response, OAUTH2_AUTHORIZATION_REQUEST_COOKIE_NAME, CookieUtil.serialize(auth2AuthorizationRequest), cookieExpireSeconds);
